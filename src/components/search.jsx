...
import { deleteLike, getProjectByCategoryId, getProjectById, getProjects, getProjectsCategory, postLike, searchWithProjectName } from "../app/reducers/projectsSlice";
      ...
      <div className="h-1/2 overflow-x-auto scrollbar-thin">
        ...
        <div className="flex gap-5 py-5 overflow-x-auto w-full scrollbar-x-thin">
          {projectsCategory.map((item) => (
            ...
            >
              <div
                className="w-full min-w-[366px] h-[195px] bg-cover bg-center rounded-xl"
                style={{
      ...
      <div className="h-1/2 py-3">
        <div className="flex flex-col">
          ...
          {showProjects.results?.map((item) => (
            <div key={item.id} className="w-full min-w-[298px] max-w-[298px] min-h-[335px]  ">
              <div
              ...
              >
                <div className="w-full relative flex flex-col gap-10 p-5">
                  <button className="absolute top-[-160px] right-[10px] flex items-center justify-center w-10 h-10 rounded-full bg-gray-500 bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-40">
                    {item.favorite ? (
                      <IoMdHeart
