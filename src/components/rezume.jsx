...
export default function Rezume() {
  ...
  console.log(selectedResume.length);
      ...
      <div className="">
        ...
        {isSelectedResume ? (
          <div className="w-full relative min-h-[233px] bg-[#8D8D8D] rounded-lg p-5">
            <GrFormPreviousLink onClick={()=>setIsSelectedResume(false)} className="absolute top-0 left-0 hover:text-main-red hover:scale-110 cursor-pointer" size={30}/>
            {selectedResume  ? (
              <div>
